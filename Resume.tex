...
\begin{document}
    ...
    \begin{tabular*}{7in}{l@{\extracolsep{\fill}}r}
        ...
        B/304, Sangham C.H.S, Suyog Nagar, Vasai(W). & \\
    ...
    \indent \begin{tabular}{ l @{\hskip 0.15in} l @{\hskip 0.15in} l @{\hskip 0.15in} l @{\hskip 0.15in} l }
        \hline
        \textbf{Degree} & \textbf{College/School} & \textbf{University} & \textbf{Year} & \textbf{Score} \\
        \hline
        B. Engineering Electronics & Fr. CRCE & Mumbai University & 2019 & 7.03 \\
        Diploma in Elec. and Telecom. & Viva College of Eng. & MSBTE & 2016 &82.00  \\
       School &St. Augustine's High School & Mumbai Board & 2013 & 81.45\\
        \hline
    \end{tabular}
    %\end{center}
    %\end{table}
    ...
    \begin{itemize}
        ...
        \item 
        \ressubheading{Autonomous Car Using CNN }{}{Degree Third Year.}{}
        \begin{itemize}
            \resitem{An AI was trained for driving a RC car.}
            \resitem{It has dataset around 12,000 labelled images, obtained from Udacity open source car simulator.}
        ...
        \begin{itemize}
            ...
            \resitem{Highly modified CAR-74 dataset, which consist of 115,200 labelled images.}
            \resitem{Written using Tflearn.}
        \end{itemize}
    
        \item
        \ressubheading{Natural Language Processing}{}{Degree Third Year.}{}
        \begin{itemize}
            \resitem{It is an ongoing project. Here an AI is designed to understand simple speech commands.}
    ...
    \begin{itemize}
        ...
        \resitem{Participated in State Level Hackathon.}
    \end{itemize}
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
