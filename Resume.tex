...
\begin{document}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \resitem{It dataset had around 12,000 labled images, obtained from udacity opensource car simulator.}
    ...
    \begin{itemize}
        ...
        \resitem{Python from}\textit{"TheNewBoston"}{a youtube channel.}
        \resitem{OpenCV from}\textit{"Sentdex"}{a youtube channel.}
    \end{itemize}
